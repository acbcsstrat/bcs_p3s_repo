...
//	    		, @RequestParam("") Object pageDescriptionUI
		...
		try{
			...
			form1200Service.saveNewForm1200details(patentId, clientRef, totalClaims, isYear3RenewalPaying, totalPages, 
									extensionStatesUI, validationStatesUI, pageDescriptionUI);
		...
		return null;
//	    perhaps
//	    return new ResponseEntity<>("aaa", "bb", HttpStatus.OK);
//	    return new ResponseEntity<String, String>("aaa", "bb", HttpStatus.OK); - nope - wrong num args
    }
    ...
    public ResponseEntity<Object> generateForm1200(@RequestBody Object obby) {
    	// Note isYear3RenewalPaying is marked optional NOT because the question is conditional, but because HTML form doesn't send unchecked checkboxes

 ...
 * 
 *  This MIGHT include processing data which arrives in an unpredicatble form: e.g. LinkedHashMap OR the requested object
...
//	public List<Long> extractOrderedPatentIdList(Object obby) {
//		// This for API action 4.1 - show basket details (et al)
//		// The data provided may be : List<Long>; LinkedHashMap; List<PatentUI> or maybe even List<Patent>    
//		
//		// DUMMY HARDCODE
//		DummyDataEngine dum = new DummyDataEngine();
//		List<Long> longs = dum.gimmeTwoLongs(); 
//		return longs;
//	}
...
//		StringTokenizer st = new StringTokenizer(commaSeparatedListOfIntegerNumbers, ",");
//		System.out.println("   Next token follows : ");

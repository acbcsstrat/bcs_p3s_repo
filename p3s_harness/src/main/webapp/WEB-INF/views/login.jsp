                  ...
                  <div class="row">
                     <div class="col-md-12 d-flex justify-content-center align-items-center flex-column">
                        <div class="m-b-md">
                           ...
                           <!-- 
                           <img src="PP_icon_lg.png" >
                            -->
                        </div>
                        
                        <h1 class="font-weight-bold font-h1">Login to P3S TEST HARNESS</h1>
                     </div>
                  </div>
               </div>
                        ...
                        <form id="ppLoginForm" action="resources/j_spring_security_check" method="post" class="form" data-parsley-validate="">
                           ...
                           <div class="form-group d-flex justify-content-center flex-column m-b-sm">
                              ...
                              <div class="btn-default">
                                 <input type="submit" value="Admin Login" class="btn btn-block pill-radius bg-phase-orange font-body txt-white font-weight-medium cursor-pointer">
                              </div>
                           </div>
                        </form>

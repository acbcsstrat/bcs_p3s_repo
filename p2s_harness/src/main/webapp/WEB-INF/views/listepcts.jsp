...
<c:forEach items="${epcts}" var="epct">
	<form action="changeepctstatus" method="POST" >							
	    <tr>
			...
			<td>
				${epct.patent.EP_ApplicationNumber} 
			</td>
			<td>
				${epct.patent.id} 
			</td>
			<td>
				${epct.patent.business.id} 
			</td>
			<td>
				${epct.patent.business.businessName} 
			</td>
			<td>
				${epct.epctStatus} 
			</td>
			...
			<td>
				<input type="hidden" name="epctId" value="${epct.id}" /> 
				<input type="submit" name="Submit" id="sub${epct.id}" onclick="this.form.submit(); " /> 
			</td>
			<td>
				<a href="/p3sharness/pdfuploadform.jsp?epctId=${epct.id}">upload</a> 
			</td>
			<td>
			...
			<td>
				${epct.epctApplicationExpiryDate} 
			</td>
			<td>
				${epct.createdBy.firstName} ${epct.createdBy.lastName} 
			</td>
			<td>
				${epct.createdDate}
			</td>

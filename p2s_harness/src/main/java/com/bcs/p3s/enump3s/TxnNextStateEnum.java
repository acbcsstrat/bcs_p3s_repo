...
public class TxnNextStateEnum extends P3SAbstractEnum {
    ...
    public TxnNextStateEnum(String instruction)  
    {
        ...
        if (instruction.equalsIgnoreCase(TxnNextStateEnum.EPO_INSTRUCTED)
                || instruction.equalsIgnoreCase("EPO_INSTRUCTED")) 
               			sofar = TxnNextStateEnum.EPO_INSTRUCTED;  

        if (instruction.equalsIgnoreCase(TxnNextStateEnum.EPO_RENEWAL_COMPLETE)
                || instruction.equalsIgnoreCase("EPO_RENEWAL_COMPLETE")) 
               			sofar = TxnNextStateEnum.EPO_RENEWAL_COMPLETE;  

        if (instruction.equalsIgnoreCase(TxnNextStateEnum.PENALTY_PAID)
                || instruction.equalsIgnoreCase("PENALTY_PAID")) 
               			sofar = TxnNextStateEnum.PENALTY_PAID;  

...
public class CostAnalysisDataEngine extends Universal{
	...
	*//*
	...
	public TreeMap<Date, RenewalFeeUI> getAllFeeUI(List<ArchivedRate> history , CostAnalysisData caData, P3SFeeSole p3sFee, EpoRenewalFee epoFee){
	...
	public CombinedFee getFeeObj(Patent patent){
		...
		epoFee = EpoRenewalFee.findEpoRenewalFeesByRenewalYear(epoFee.getRenewalYear());

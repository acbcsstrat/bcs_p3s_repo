...
// AndyC: June 2017  - Entire Class is commented out, until we find if we have a use for it
 ...
 * 
 * Dependencies:
 *   EnvironmentSpecificProperties, P3SenvironmentKnowledge, Logging & Universal
 *   
 * @author andyc
 *
 *
 ...
 *  
 *  However, as an aide, a different exception (PEpropertyException) is created for this scenario.
 */
public class PEPropertyReader extends Universal {

//	protected EnvironmentSpecificProperties esp = null;
//	
//	/**
//	 * Instantiate & Attempt to open & read the mail PE2 property file
//	 * @throws IOException 
//	 */
//	public PEPropertyReader() throws IOException {
//		doConstructorStuff();
//	}
//	
//	/**
...
//	 * @param ignored
//	 */
//	public PEPropertyReader(int ignored) {
//		try {
//			doConstructorStuff();
//		}
...
//		String path = P3SEnvironmentKnowledge.getPropertyFilePath(); 
//		String filename = P3SEnvironmentKnowledge.PROPERTYFILENAME;
...
//		if (esp==null) System.out.println("PEPropertyReader:getEsp is null. Expect NPE.");
//		return esp; 
//	}
//
//	/**

angular.module('ppApp').controller('grantsGraphCtrl', grantsGraphCtrl);

grantsGraphCtrl.$inject = ['$stateParams', '$scope', '$timeout', 'dashboardService'];

function grantsGraphCtrl($stateParams, $scope, $timeout, dashboardService) {

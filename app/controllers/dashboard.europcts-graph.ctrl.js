angular.module('ppApp').controller('europctsGraphCtrl', europctsGraphCtrl);

europctsGraphCtrl.$inject = ['$stateParams', '$scope', '$timeout', 'dashboardService'];

function europctsGraphCtrl($stateParams, $scope, $timeout, dashboardService) {

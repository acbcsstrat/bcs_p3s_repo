angular.module('ppApp').controller('renewalsGraphCtrl', renewalsGraphCtrl);

renewalsGraphCtrl.$inject = ['$stateParams', '$scope', '$timeout', 'dashboardService'];

function renewalsGraphCtrl($stateParams, $scope, $timeout, dashboardService) {

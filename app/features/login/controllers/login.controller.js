LoginController.$inject = ['$state', '$rootScope','$http', '$scope', '$cookies', 'AuthorisationService']

export default function LoginController($state, $rootScope, $http, $scope, $cookies, AuthorisationService) {

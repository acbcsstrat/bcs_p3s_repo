...
import fulfilment from './ngCart.fulfilment.js';
    ...
    return {
        ...
        template: function(element, attrs) {
            if ( typeof attrs.templateUrl == 'undefined' ) {
                return require('html-loader!./html/addtocart.htm').default;
            } else {
...
.directive('ngcartCart', [function(){
    return {
        ...
        template: function(element, attrs) {
            if ( typeof attrs.templateUrl == 'undefined' ) {
                return require('html-loader!./html/cart.htm').default;
            } else {
                return attrs.templateUrl;
            }
        },
...
.directive('ngcartSummary', [function(){
    return {
        ...
        template: function(element, attrs) {
            if ( typeof attrs.templateUrl == 'undefined' ) {
                return require('html-loader!./html/summary.htm').default;
            } else {
                return attrs.templateUrl;
            }
        }
...
.directive('ngcartCheckout', ['ngCart', 'ngCartItem', 'BasketService', 'CasesRestService', '$rootScope', '$timeout',  '$state', function(ngCart, ngCartItem, BasketService, CasesRestService, $rootScope, $timeout,  $state){
    return {
        ...
        template: function(element, attrs) {
            if ( typeof attrs.templateUrl == 'undefined' ) {
                return require('html-loader!./html/checkout.htm').default;
            } else {
                return attrs.templateUrl;
            }
        }
